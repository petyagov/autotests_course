...
def treatment_sum(our_tuple: tuple):
    """
    Функция проверяет количество элементов, и если в кортеже 2 элемента и их можно сложить, то выводит сумму,
    иначе выводит исключение
    :param our_tuple: кортеж
    :return: сумма 2-х элементов или исключение
    """
    if len(our_tuple) < 3:
        try:
        ...
        raise Exception('Много данных')  # Поднимаем исключение 'Много данных'
