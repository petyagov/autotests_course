...
def letter_stat(our_str):
    ...
    """
    Получаем словарь, где ключами являются буквы строки, а значениями ключа числа,
    т.е. количество данной буквы в слове
    :param our_str: строка, которую принимаем на вход
    :return: словарь из ключей-букв и значений-чисел повторений данной буквы
    """
    # При помощи генератора создаем словарь, где ключом выступает уникальный элемент строки,
    # а значением - его количество или частота в строке (вычисляется методом count())
